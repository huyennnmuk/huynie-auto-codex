...
class ProjectAnalyzer:
    ...
    def gather_context(self) -> dict:
        ...
        # Get project index (from .auto-codex - the installed instance)
        project_index_path = self.project_dir / ".auto-codex" / "project_index.json"
        ...
        if self.include_roadmap:
            roadmap_path = (
                self.project_dir / ".auto-codex" / "roadmap" / "roadmap.json"
            )
            ...
            discovery_path = (
                self.project_dir / ".auto-codex" / "roadmap" / "roadmap_discovery.json"
            )
        ...
        if self.include_kanban:
            specs_dir = self.project_dir / ".auto-codex" / "specs"
            if specs_dir.exists():
