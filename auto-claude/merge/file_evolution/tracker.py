...
class FileEvolutionTracker:
    ...
    - File content snapshots in .auto-codex/baselines/
    ...
    def __init__(
        ...
        Args:
            ...
            storage_dir: Directory for evolution data (default: .auto-codex/)
        ...
        storage_dir = storage_dir or (self.project_dir / ".auto-codex")
