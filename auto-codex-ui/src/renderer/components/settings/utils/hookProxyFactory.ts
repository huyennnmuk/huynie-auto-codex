...
export function createHookProxy(
  ...
  return {
    ...
    get showCodexToken() { return hookRef.current.showCodexToken; },
    get setShowCodexToken() { return hookRef.current.setShowCodexToken; },
    ...
    get isCheckingCodexAuth() { return hookRef.current.isCheckingCodexAuth; },
    get codexAuthStatus() { return hookRef.current.codexAuthStatus; },
    get setCodexAuthStatus() { return hookRef.current.setCodexAuthStatus; },
    ...
    get handleCodexSetup() { return hookRef.current.handleCodexSetup; },
